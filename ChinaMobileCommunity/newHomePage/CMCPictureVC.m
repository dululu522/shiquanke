...
@interface CMCPictureVC ()<UITableViewDataSource,UITableViewDelegate>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 0) {
        if (self.dis_goodsArr) {
//            [cell creatOfferDetailsCellNameLabel:[self.dis_goodsArr objectAtIndex:indexPath.row]];
            [cell creatOfferDetailsCellNameLabel:[self.dis_goodsArr objectAtIndex:indexPath.row] numberLabel:nil priceText:@""];
        }
