...
function doSubmit()
{
	if(valitorInput())
	{
      ...
      cardform.action = "<%=path%>/PayWebServlet?index=1";
      cardform.submit();
							...
							<tr>
								...
								<td>
									<input name="PRODUCTAMOUNT" value='' type="text"
										class="normal_input" size="60" maxlength="60" tabIndex='1'>格式应为保留小数点后2位如：(1.00)
								</td>
							</tr>
							<tr>
								<td align="right">
								...
								<td>
									<input name="ATTACHAMOUNT" value='' type="text"
										class="normal_input" size="60" maxlength="60" tabIndex='1'>格式应为保留小数点后2位如：(2.00)
								</td>
							</tr>
							<tr>
								<td align="right">
