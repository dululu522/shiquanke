...
@interface CMCMyOrderServiceOrderedVC ()
{
    UIView *_backView;
...
@implementation CMCMyOrderServiceOrderedVC
...
- (void)creatMakeSureOrder
{
    ...
    [makeSureBtn setTitle:@"确认订单" forState:UIControlStateNormal];
...
//        [cell creatMyOrderDetailCellStatus:@"已接单" type:@"服务项目"];
        [cell creatMyOrderDetailCellStatus:@"已接单" type:@"服务项目" name:@"" time:@""];
